...
//    _textField.font = [UIFont fontWithName:@"STHeitiSC-Medium" size:15];
    _textField.font = [NNCommonDeal getFont:15];
    _textField.text = @"1";
...
- (void)commonSetup{
    CGFloat viewH = self.frame.size.height;//34
    CGFloat viewW = self.frame.size.width;//34*3 = 102
    ...
    _textField.frame = CGRectMake(viewH, 0, viewH, viewH);
}
