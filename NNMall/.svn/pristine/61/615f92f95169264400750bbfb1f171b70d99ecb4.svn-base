...
- (void)viewDidLoad
{
  ...
  [self setupSubviews];
    ...
    backBar.tintColor = [UIColor colorWithRed:231/255.0f green:132/255.0f blue:114/255.0f alpha:1.0f];
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    //设置NavigationBar背景颜色
    [self.navigationController.navigationBar setBarTintColor:[UIColor colorWithRed:246/255.0f green:246/255.0f blue:246/255.0f alpha:1.0f]];
    [self.navigationController.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor colorWithRed:231/255.0f green:132/255.0f blue:114/255.0f alpha:1.0f]}];
}
...
- (void)reset
{
  ...
  [self scrollToViewWithIndex:_selectedIndex animated:NO];
  [self segmentBarScrollToIndex:_selectedIndex animated:NO];
