...
{
    [self.p_textField setTranslatesAutoresizingMaskIntoConstraints:NO];
    [self.p_mobile setTranslatesAutoresizingMaskIntoConstraints:NO];
...
-(IBAction)login:(id)sender
{
    ...
    if ([m_phone length] == 11&&[m_code length] == 4) {
        ...
        {
            [m_NNLoginViewDelegate loginDelegate:m_phone andPassW:m_code];
        }
    }else
    {
...
{
    [self.p_mobile resignFirstResponder];
