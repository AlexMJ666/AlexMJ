...
{
    UILabel *line = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, kMainScreen_Width, 1)];
    line.backgroundColor = LGraycolor;
    [self addSubview:line];
    
    
    
    UIButton *cartBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    cartBtn.frame = CGRectMake(kMainScreen_Width-152, 3, 148, 44);
    [cartBtn setTitle:@"加入购物车" forState:UIControlStateNormal];
    cartBtn.backgroundColor = Redcolor;
